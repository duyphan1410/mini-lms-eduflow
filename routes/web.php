...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware('role:instructor')->prefix('instructor')->name('instructor.')->group(function () {
        ...
        Route::resource('courses.lessons.quizzes', QuizController::class); // quiz → tạo/sửa/xóa quiz + questions + options
        ...
        Route::get('quizzes', fn() => view('instructor.quizzes'))->name('quizzes'); //quiz
    ...
    Route::middleware('role:student')->prefix('student')->name('student.')->group(function () {
        ...
        Route::get('lessons/{lesson}/quiz',         [QuizController::class, 'show'])->name('quiz.show');  // quiz
        Route::post('lessons/{lesson}/quiz', [ProgressController::class, 'submitQuiz'])->name('lessons.quiz.submit'); // quiz
